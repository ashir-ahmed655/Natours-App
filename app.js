...
app.use('/web-hookCheckout',express.raw({type: 'application/json'}),bookingController.webHookCheckout) // returns sessionData, needed for making booking doc on successful payment 
