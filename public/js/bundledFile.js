...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    // will put in id map which we already had in our pugs else we can also change name here to other id.
  ...
  var bounds = new mapboxgl.LngLatBounds(); //make a bound obj to further down the line set map display such that all locations are visible. 
  ...
  var mark_spot = document.createElement('div');
  mark_spot.className = 'marker';
  locations.forEach(function (element) {
    ...
    new mapboxgl.Marker({
      element: mark_spot,
      // give marker to mapbox to use it.
      anchor: 'bottom' // tell it which point of marker should point to the coordinates.
...
var hideAlert = function hideAlert() {
  var alert_present = document.querySelector('.alert');
...
var showAlert = function showAlert(type, message) {
  ...
  var generateHTML = "<div class=\"alert alert--".concat(type, "\">").concat(message, "</div>"); //since already made css files have alert,alert--success/error 
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              //Only modern browsers can run this async await code.
              method: 'POST',
              url: 'http://127.0.0.1:6969/api/v1/users/login',
              data: {
                email: email,
                // 1st email is the email sent in req.body 2nd is the email parameter in this func.
                password: password
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              // checking if we sent res success after hitting the above url successfully.
              console.log("Success");
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updateUserProfile_Password.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.update_userInfo = exports.updatePassword = void 0;
...
var update_userInfo = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            updated_User = _context.sent;

            // console.log(updated_User);
            if (updated_User.data.status === "success") {
              (0, _alert.showAlert)('success', "User Profile Updated Successfully");
              window.setTimeout(function () {
                location.assign('/me');
              }, 1300);
            }
  ...
  return function update_userInfo(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(password, change_password, change_passwordConfirm) {
    var resp;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                ...
                change_passwordConfirm: change_passwordConfirm
              }
            });
...
var stripe = Stripe('pk_test_51LopSlIkUpKKxr58KHKIROQYdrkgmVcnI6RqfT3SQvkclDaHF7atuyXtPO4Kdu7N6xc04BRcvs1ohHjb8y9DEPnu00SjBtEkKF'); //publicKey got from my stripe account Also this Stripe
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:6969/api/v1/bookings/checkoutSession/".concat(tourId));

          case 3:
            session = _context.sent;
            //simple get req from axios else we also have a complex way in other files in this js folder.
            console.log(session); //2) create checkoutForm & charge the card
...
var _updateUserProfile_Password = require("./updateUserProfile_Password");
...
var loginPage = document.querySelector('.form--loogin'); //name stupid becuz we couldn't use prev(.form) becuz we needed it to send updates from
// another form(Think account updation form (chk account.pug))

var logoutBtn = document.querySelector('.nav__el--logout'); // class present on logout btn

var userProfileForm = document.querySelector('.form-user-data');
var userPassForm = document.querySelector('.form-user-password');
var bookTourBtn = document.getElementById('book-tour'); //! DELEGATING METHODS:

if (mapBox) {
  // If html has an element with id 'map' then mapbox will be called.Assuming only tours detail page have an element with id 'map'
...
if (userProfileForm) {
  userProfileForm.addEventListener('submit', function (e) {
    ...
    (0, _updateUserProfile_Password.update_userInfo)(form);
  });
}
...
if (userPassForm) {
  userPassForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var Current_pass, Change_pass, Change_pass_Confirm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              Current_pass = document.getElementById('password-current').value;
              Change_pass = document.getElementById('password').value;
              Change_pass_Confirm = document.getElementById('password-confirm').value;
              _context.next = 7;
              return (0, _updateUserProfile_Password.updatePassword)(Current_pass, Change_pass, Change_pass_Confirm);
...
//# sourceMappingURL=/bundledFile.js.map