...
export const bookTour= async tourId=>{
    try{
        ...
        const session = await axios(`http://127.0.0.1:6969/api/v1/bookings/checkoutSession/${tourId}`)  //simple get req from axios else we also have a complex way in other files in this js folder.
        console.log(session)
